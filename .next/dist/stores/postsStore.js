...
var PostContent = exports.PostContent = _mobxStateTree.types.model("PostContent", {
...
var Post = exports.Post = _mobxStateTree.types.model("Post", {
  ...
  changed: _mobxStateTree.types.number,
  status: _mobxStateTree.types.enumeration("Status", [PostStatus.Draft, PostStatus.Published]),
  published: _mobxStateTree.types.maybe(PostContent),
  draft: _mobxStateTree.types.maybe(PostContent)
});

var PostsStore = exports.PostsStore = _mobxStateTree.types.model("PostsStore", {
  posts: _mobxStateTree.types.map(Post),
  arePostsLoaded: _mobxStateTree.types.boolean,
  sortBy: _mobxStateTree.types.enumeration("sortBy", [PostsOrder.Newest, PostsOrder.Oldest, PostsOrder.ByPublication]),
  ...
  return {
    ...
    getPost: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function getPost(id) {
      var doc, post;
      return _regenerator2.default.wrap(function getPost$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _firebaseInit.firestore.collection("posts").doc(id).get();
    ...
    fetchAllPosts: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function fetchAllPosts() {
      var querySnapshot;
      return _regenerator2.default.wrap(function fetchAllPosts$(_context2) {
        while (1) {
      ...
      }, fetchAllPosts, this, [[0, 8]]);
    })),

    fetchPost: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function fetchPost(id) {
      var post;
      return _regenerator2.default.wrap(function fetchPost$(_context3) {
        while (1) {
    ...
    savePost: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function savePost(id, title, text) {
      var post, now, updatedPost;
      return _regenerator2.default.wrap(function savePost$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt("return", self.saveNewPost(title, text));
            ...
            case 4:
              ...
              _context4.next = 10;
              return _firebaseInit.firestore.collection("posts").doc(id).update(updatedPost);
    ...
    saveNewPost: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function saveNewPost(title, text) {
      var newDraftRef, id, now, currentAuthor, newPost;
      return _regenerator2.default.wrap(function saveNewPost$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              newDraftRef = _firebaseInit.firestore.collection("posts").doc();
              id = newDraftRef.id;
              now = _moment2.default.now();
    ...
    updateMeta: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function updateMeta(id, values) {
      var post, now, updatedPost;
      return _regenerator2.default.wrap(function updateMeta$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              ...
              updatedPost = (0, _extends3.default)({}, post, {
                ...
                draft: (0, _extends3.default)({}, post.draft, {
                  changed: now,
                  meta: (0, _extends3.default)({}, post.draft.meta, values)
                })
              });
    ...
    deleteDraftPost: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function deleteDraftPost(id) {
      var post;
      return _regenerator2.default.wrap(function deleteDraftPost$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 5:
              _context7.next = 7;
              return _firebaseInit.firestore.collection("posts").doc(id).delete();
      ...
      }, deleteDraftPost, this);
    })),

    publishPost: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function publishPost(id) {
      var post, now, content, updatedPost;
      return _regenerator2.default.wrap(function publishPost$(_context8) {
        while (1) {
    ...
    unpublishPost: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function unpublishPost(id) {
      var post, now, updatedPost;
      return _regenerator2.default.wrap(function unpublishPost$(_context9) {
        while (1) {
    ...
    discardDraftChanges: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function discardDraftChanges(id) {
      var post, updatedPost;
      return _regenerator2.default.wrap(function discardDraftChanges$(_context10) {
        while (1) {
      ...
      }, discardDraftChanges, this);
    })),

    verifyDraftIsValid: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function verifyDraftIsValid(id) {
      var post, draft, meta;
      return _regenerator2.default.wrap(function verifyDraftIsValid$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 2:
              ...
              if (!(!draft.title || !draft.text || !meta || !meta.url || !meta.language || !meta.author || !meta.category || !meta.date || !meta.thumbImage || !meta.thumbText || !meta.thumbText)) {
                _context11.next = 7;
                break;
              }
      ...
      }, verifyDraftIsValid, this);
    })),

    copyPost: (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function copyPost(copyId) {
      var post, newDraftRef, id, now, newPost;
      return _regenerator2.default.wrap(function copyPost$(_context12) {
        while (1) {
