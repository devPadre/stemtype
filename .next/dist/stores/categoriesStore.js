...
var CategoriesStore = exports.CategoriesStore = _mobxStateTree.types.model("CategoriesStore", {
  ...
  var fetchCategories = (0, _mobxStateTree.flow)( /*#__PURE__*/_regenerator2.default.mark(function fetchCategories() {
    var querySnapshot;
    return _regenerator2.default.wrap(function fetchCategories$(_context) {
      while (1) {
