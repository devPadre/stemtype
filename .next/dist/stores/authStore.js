...
var AuthStore = (exports.AuthStore = _mobxStateTree.types
  .model("AuthStore", {
    user: _mobxStateTree.types.optional(
      _mobxStateTree.types.union(User, _mobxStateTree.types.literal(null)),
      null
    ),
  ...
  .actions(function(self) {
    return {
      subscribe: function subscribe() {
        ...
        var disposer = _firebaseInit.auth.onAuthStateChanged(
          onAuthStateChanged
        );
        (0, _mobxStateTree.addDisposer)(self, disposer);
      },

      verifyIfUserIsAuthor: (0, _mobxStateTree.flow)(
        /*#__PURE__*/ _regenerator2.default.mark(function verifyIfUserIsAuthor(
          user
        ) {
          var doc;
          return _regenerator2.default.wrap(
            function verifyIfUserIsAuthor$(_context) {
              while (1) {
