...
var BlogStore = (exports.BlogStore = _mobxStateTree.types
  .model("BlogStore", {
    ...
    categories: _mobxStateTree.types.optional(
  ...
  .actions(function(self) {
    return {
      backup: (0, _mobxStateTree.flow)(
        /*#__PURE__*/ _regenerator2.default.mark(function backup() {
          var _this = this;

          var collections, result, _loop, i;

          return _regenerator2.default.wrap(
            function backup$(_context2) {
              while (1) {
