...
var BasicItemImage = _styledComponents2.default.div(_templateObject, function(
  props
) {
  return props.visible
    ? (0, _styledComponents.css)(_templateObject2, function(props) {
        return props.src;
      })
    : "";
});

var DefaultItemImage = (0, _styledComponents2.default)(BasicItemImage)(
  _templateObject3,
  function(props) {
...
var FeaturedItemImage = (0, _styledComponents2.default)(BasicItemImage)(
  _templateObject4,
  function(props) {
    return props.theme.flexboxgrid.breakpoints.sm + "em";
  },
...
var ItemImage = (function(_React$Component) {
  ...
  function ItemImage(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(
      this,
      (ItemImage.__proto__ || (0, _getPrototypeOf2.default)(ItemImage)).call(
        this,
        props
      )
    );
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            Component,
            (0, _extends3.default)({}, rest, { visible: this.state.isVisible })
          )
        );
      }
    }
