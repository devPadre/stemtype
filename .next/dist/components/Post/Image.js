...
var ImageContainer = _styledComponents2.default.figure(
  _templateObject,
  function(props) {
    return (
  ...
  function(props) {
    return (
      ...
      (0, _styledComponents.css)(
        _templateObject3,
        _media2.default.sm(_templateObject4)
      )
    );
  },
  function(props) {
    return (
      ...
      (0, _styledComponents.css)(
        _templateObject5,
        _media2.default.sm(_templateObject6)
      )
    );
  }
);
...
var DelayedImage = (function(_React$Component) {
  ...
  function DelayedImage(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(
      this,
      (
        DelayedImage.__proto__ || (0, _getPrototypeOf2.default)(DelayedImage)
      ).call(this, props)
    );
      ...
      value: function render() {
        ...
        var img = zoomSrc
          ...
          : _react2.default.createElement(
              "img",
              (0, _extends3.default)({ alt: caption }, rest, { src: src })
            );
...
var ImageComponent = (function(_React$Component2) {
  ...
  function ImageComponent(props) {
    ...
    var _this3 = (0, _possibleConstructorReturn3.default)(
      this,
      (
        ImageComponent.__proto__ ||
        (0, _getPrototypeOf2.default)(ImageComponent)
      ).call(this, props)
    );
  ...
  (0, _createClass3.default)(ImageComponent, [
    {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          { partialVisibility: true, onChange: this.onChangeVisibility },
          _react2.default.createElement(
            ImageContainer,
            { position: position },
            previewSrc &&
              _react2.default.createElement(DelayedImage, {
                className: "small",
                src: previewSrc
              }),
            !lazy &&
              _react2.default.createElement(
                DelayedImage,
                (0, _extends3.default)({ src: src, zoomSrc: zoomSrc }, rest)
              ),
            lazy &&
            ...
            caption &&
              _react2.default.createElement(ImageCaption, null, caption)
          )
        );
      }
    }
