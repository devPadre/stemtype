...
var SocialButtons = (function(_React$Component) {
  ...
  function SocialButtons() {
    ...
    return (0, _possibleConstructorReturn3.default)(
      this,
      (
        SocialButtons.__proto__ || (0, _getPrototypeOf2.default)(SocialButtons)
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              FacebookShareButton,
              { url: shareUrl, quote: this.props.title },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              VKShareButton,
              { url: shareUrl, windowWidth: 660, windowHeight: 460 },
              _react2.default.createElement(VKIcon, { size: 32, round: true })
            ),
            _react2.default.createElement(VKShareCount, {
              url: shareUrl,
              className: "count"
            })
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              OKShareButton,
              { url: shareUrl, windowWidth: 660, windowHeight: 460 },
              _react2.default.createElement(OKIcon, { size: 32, round: true })
            ),
            _react2.default.createElement(OKShareCount, {
              url: shareUrl,
              className: "count"
            })
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              TwitterShareButton,
              { url: shareUrl, title: this.props.title },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              TelegramShareButton,
              { url: shareUrl, title: this.props.title },
              _react2.default.createElement(TelegramIcon, {
                size: 32,
                round: true
              })
            )
