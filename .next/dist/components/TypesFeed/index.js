...
var TypesFeed = function (_React$Component) {
  (0, _inherits3.default)(TypesFeed, _React$Component);

  function TypesFeed() {
    (0, _classCallCheck3.default)(this, TypesFeed);

    return (0, _possibleConstructorReturn3.default)(this, (TypesFeed.__proto__ || (0, _getPrototypeOf2.default)(TypesFeed)).apply(this, arguments));
  }

  (0, _createClass3.default)(TypesFeed, [{
    key: "renderRow",
...
TypesFeed.defaultProps = {
  featured: true,
  placeholder: ""
};

exports.default = TypesFeed;