...
var AdminNewStory = exports.AdminNewStory = (_dec = (0, _mobxReact.inject)("blog"), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
  ...
  function AdminNewStory() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = AdminNewStory.__proto__ || (0, _getPrototypeOf2.default)(AdminNewStory)).call.apply(_ref, [this].concat(args))), _this), _this.fetchPost = function (postId) {
      _this.props.blog.posts.fetchPost(postId).catch(function (error) {
        _index2.default.push("/admin/editor", "/admin/editor", { shallow: true });
      });
    }, _this.onSaveDraft = function (title, text) {
      return _this.props.blog.posts.savePost(_this.props.postId, title, text).then(function (newId) {
      ...
      return _this.props.blog.posts.updateMeta(_this.props.postId, values).catch(function (error) {
        console.error(error);
        _antd.Message.error("Couldn't save changes");
      });
    }, _this.onPublish = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      var post;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _this.props.blog.posts.publishPost(_this.props.postId);
    ...
    })), _this.onVerifyReadyForPublish = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
      var valid;
      return _regenerator2.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this.props.blog.posts.verifyDraftIsValid(_this.props.postId);
            ...
            case 2:
              ...
              _antd.Message.warning("Not all required settings are set. Cannot publish the changes.");
      ...
      return _this.props.blog.posts.unpublishPost(_this.props.postId).then(function () {
        _antd.Message.success("The post is un-published");
      }).catch(function (error) {
        _antd.Message.error("Couldn't un-publish the post");
      });
    }, _this.onCopy = function () {
      return _this.props.blog.posts.copyPost(_this.props.postId).then(function (newId) {
      ...
      var win = window.open(window.location.origin + "/preview?id=" + _this.props.postId, "_blank");
      if (win) {
      ...
      return _this.props.blog.posts.deleteDraftPost(_this.props.postId).then(function () {
        _index2.default.push("/admin");
      }).catch(function (error) {
        _antd.Message.error("Couldn't delete the post");
      });
    }, _this.onDiscardChanges = function () {
      return _this.props.blog.posts.discardDraftChanges(_this.props.postId).then(function () {
  ...
  (0, _createClass3.default)(AdminNewStory, [{
    ...
    value: function render() {
      var currentPost = this.props.blog.posts.getPostForEditor(this.props.postId);
      return _react2.default.createElement(_AdminPage2.default, { user: this.props.user, noPadding: true }, _react2.default.createElement(_StoryEditor2.default, {
        initialValues: {
...
exports.default = function (props) {
  return _react2.default.createElement(_ConnectedPage2.default, null, _react2.default.createElement(_ProtectedPage2.default, null, function (_ref4) {
    var user = _ref4.user;
    return _react2.default.createElement(AdminNewStory, (0, _extends3.default)({}, props, { user: user, postId: props.url.query.id }));
  }));
};