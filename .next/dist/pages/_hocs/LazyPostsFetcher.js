  ...
  return (function(_React$Component) {
                ...
                function _callee$(_context) {
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        _context.next = 2;
                        return Api.fetchAllPublishedPosts(
                          query.lang,
                          POSTS_PER_PAGE
                        );
                      ...
                      case 2:
                        ...
                        return _context.abrupt(
                          "return",
                          (0, _defineProperty3.default)({}, query.lang, {
                            posts: posts,
    ...
    function LazyPostsFetcher(props) {
      ...
      var _this = (0, _possibleConstructorReturn3.default)(
        this,
        (
          LazyPostsFetcher.__proto__ ||
          (0, _getPrototypeOf2.default)(LazyPostsFetcher)
        ).call(this, props)
      );
          ...
          function(posts) {
            _this.setState(function(state) {
              return (0, _defineProperty3.default)({}, lang, {
                posts: [].concat(
                  (0, _toConsumableArray3.default)(state[lang].posts),
                  (0, _toConsumableArray3.default)(posts)
                ),
        ...
        value: function componentWillReceiveProps(nextProps) {
          ...
          if (!this.state[nextLanguage] && nextLanguage !== currentLanguage) {
            this.setState(function(state) {
              return (0,
              _defineProperty3.default)({}, nextLanguage, state[currentLanguage]);
            });
            Api.fetchAllPublishedPosts(nextLanguage, POSTS_PER_PAGE).then(
              function(posts) {
                _this2.setState(
                  (0, _defineProperty3.default)({}, nextLanguage, {
                    posts: posts,
                    hasMore: posts.length === POSTS_PER_PAGE
                  })
                );
